...
### 6. category（视频类型）
自动分类此影视文件：
- **anime**: 动漫、二次元番剧（包含明显的日漫字幕组如 [ANi], [Lilith-Raws] 等，或罗马音/日文标题）。
- **tv**: 真人电视剧、美剧、韩剧、国产剧（例如 S01E01，多季连续剧等特征）。
- **movie**: 剧场版、电影。如果文件名含 "Movie", "剧场版", "映画", 或明显是单集长片电影的。
如果没有明显特征，优先猜 anime 或 tv。
